...
model_generator.add_custom_comparation_metric(lambda data: 0.5)
...
# })
# model_generator.add_custom_comparation_metric_with_weight(lambda data: 0.5, 1)
...
#   ComparationMetricEnum.min_max_diff: 1.5,
# })
# model_generator.add_custom_comparation_metric_with_constraint(lambda data: 0.5, 0.6)
